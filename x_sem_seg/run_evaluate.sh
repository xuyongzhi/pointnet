...
python batch_inference.py --model_path log6_0d01_4096/model.ckpt --dump_dir log6_0d01_4096/dump_eva_spl --output_filelist log6_0d01_4096/output_filelist_eva_1.txt --room_data_filelist meta/area6_data_label_1.txt --visu
